...
; INPUT: [bp+12] grid offset, [bp+10] previous_balls offset, [bp+8] Balls_template offset, [bp+6] balls offset, [bp+4] ball index
; OUTPUT: [bp+12] 0 if the ball entered a pocket, 1 if not.
proc pockets
	push bp
	mov bp, sp
	push di ax bx cx dx
...
; INPUT: [bp+4] balls offset, [bp+6] Balls_template offset, [bp+8] previous_balls offset, [bp+10] grid offset, [bp+12] fpu_mem offset, [bp+14] gamemode offset, [bp+16] foul offset, [bp+18] cue_collided offset
; OUTPUT: None.
...
; INPUT: [bp+20] cue_collided offset, [bp+18] foul offset, [bp+16] previous_balls offset, [bp+14] balls offset, [bp+12] friction offset, [bp+10] gamemode offset, [bp+8] fpu_mem offset, [bp+6] grid offset, [bp+4] ball_template offset
; OUTPUT: None.
