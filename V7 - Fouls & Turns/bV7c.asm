; V7c - THIS VERSION INCLUDES:
		; - Collision physics
		; - Pockets
		; - Cue
		; - Correct balls colors
		; - Fouls - bad hit, no rail 
...
; INPUT: [bp+14] pocketed offset, [bp+12] grid offset, [bp+10] previous_balls offset, [bp+8] Balls_template offset, [bp+6] balls offset, [bp+4] ball index
; OUTPUT: [bp+14] 0 if the ball entered a pocket, 1 if not.
proc pockets
	push bp
	mov bp, sp
	push di bx
