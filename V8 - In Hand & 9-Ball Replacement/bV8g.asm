; V8g - THIS VERSION INCLUDES:
		; - Collision physics
		; - Pockets
		; - Cue
		; - Fouls
		; - In hand
		; - Procedure for respotting the nine ball
...
; INPUT: [bp+22] ball_template offset, [bp+20] balls offset, [bp+18] nine_pocketed offset, [bp+16] gamemode offset, [bp+14] fouls_counter offset, [bp+12] cue_collided offset, [bp+10] rail offset, [bp+8] pocketed offset, [bp+6] foul offset, [bp+4] current_player offset
; OUTPUT: None.
proc handleFouls
	push bp
	mov bp, sp
...
; INPUT: [bp+16] foul offset, [bp+14] current_player offset, [bp+12] fouls_counter offset, [bp+10] balls offset, [bp+8] ball_template offset, [bp+6] gamemode offset, [bp+4] nine_pocketed offset
; OUTPUT: None.
proc doFoul
	push bp
	mov bp, sp
