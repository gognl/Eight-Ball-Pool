; V3b - THIS VERSION INCLUDES THE FINAL PHYSICS PART:
		; - BB Collision Detection & Response
		; - Friction with table
		; - WASD movement
		; - BW Collision Detection & Response
		; - Some bugs with the BB collision
