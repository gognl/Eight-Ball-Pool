; V9a - THIS VERSION INCLUDES:
		; - Collision physics
		; - Pockets
		; - Cue
		; - Fouls
		; - In hand
		; - Respots the nine ball if it's pocketed illegally
		; - Initial racking - diamond shaped, not random yet
...
; INPUT: [bp+12] current_player offset, [bp+10] cursor_backup offset, [bp+8] ball_template offset, [bp+6] balls offset, [bp+4] grid offset
; OUTPUT: None.
