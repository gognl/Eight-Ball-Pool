; V9i - THIS VERSION INCLUDES:
		; - Collision physics
		; - Game
		; - Initial racking - diamond shaped, random
		; - Break fouls - FIXED
		; - Cue in hand behind head string on break shot
		; - Push out with temporary keyboard input
		; - Organized beginning-of-game procedures
...
; INPUT: [bp+30] nine_pocketed, [bp+28] pocketed, [bp+26] rail, [bp+24] cue_collided, [bp+22] foul, [bp+20] previous_balls, [bp+18] balls, [bp+16] friction, [bp+14] gamemode, [bp+12] fpu_mem, [bp+10] grid, [bp+8] ball_template, [bp+6] cursor_backup, [bp+4] previous_cursor
; OUTPUT: None.
...
; INPUT: [bp+20] previous_cursor offset, [bp+18] cursor_backup offset, [bp+16] balls offset, [bp+14] fpu_mem offset, [bp+12] grid offset, [bp+10] ball_template offset, [bp+8] gamemode offset, [bp+6] pocketed offset, [bp+4] push_out offset
; OUTPUT: None.
...
; INPUT: [bp+14] push_out offset, [bp+12] cursor_backup offset, [bp+10] previous_cursor offset, [bp+8] balls offset, [bp+6] fpu_mem offset, [bp+4] gamemode offset
; OUTPUT: None.
