; V6e - THIS VERSION INCLUDES:
		; - Collision physics
		; - Pockets
		; - Cue
		; - Consistent naming template for procedures & variables
		; - Some bug fixes
		; - More organized code - procedures for handling gamemodes, rewritten the reposition procedure, and more
		; - Removed the pockets-changing-color feature
...
; INPUT: [bp+14] Balls_template offset, [bp+12] fpu_mem offset, [bp+10] balls offset, [bp+8] ball index, [bp+6] grid offset, [bp+4] previous_balls offset
; OUTPUT: None.
proc collisionBB
	push bp
	mov bp, sp
...
; INPUT: [bp+4] balls offset, [bp+6] Balls_template offset, [bp+8] previous_balls offset, [bp+10] grid offset, [bp+12] fpu_mem offset, [bp+14] gamemode offset 
; OUTPUT: None.
...
; INPUT: [bp+16] previous_balls offset, [bp+14] balls offset, [bp+12] friction offset, [bp+10] gamemode offset, [bp+8] fpu_mem offset, [bp+6] grid offset, [bp+4] ball_template offset
; OUTPUT: None.
