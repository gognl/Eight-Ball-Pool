; V1f - THIS VERSION INCLUDES THE OPTIMIZED (BROAD & NARROW PHASE) BB COLLISION DETECTION SYSTEM, WITH THE SCREEN. WASD MOVEMENT. CHECKS COLLISION FOR EACH MOVING BALL. INITIALIZE PROC.
...
; gets the keyboard input and changes the x,y of the first ball accordingly.
